...
{
    draw_sprite_pixelated(oCharacter.sprite_index, oCharacter.image_index, argument1, argument2, argument10, 1, image_angle, 16777215, 1, oCharacter.sizeX, oCharacter.sizeY, 64);
    exit;
}
