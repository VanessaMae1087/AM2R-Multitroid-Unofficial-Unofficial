...
{
    case rm_a2a04:
        sprite_index = chooseCoreX(oControl.mod_jumpball);
        break;

    case rm_a3a01:
        sprite_index = chooseCoreX(oControl.mod_spacejump);
        roomoffsety = -100;
        break;

    case rm_a5b03a:
        sprite_index = chooseCoreX(oControl.mod_ice);
        break;

    case rm_a8a11:
        sprite_index = chooseCoreX(oControl.mod_50);
        break;
}
