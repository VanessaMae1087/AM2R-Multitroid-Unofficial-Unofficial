if (global.shortcuts)
{
    ...
    switch (room)
    {
        case rm_a0h04d:
            ...
            if (!(oControl.mod_previous_room == 396 && global.item[8] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 816, 304);
        ...
        case rm_a2c01:
            ...
            {
                var mtid = tile_layer_find(-111, 32, 144);
        ...
        case rm_a0h28:
            ...
            if (!(oControl.mod_previous_room == 397 && global.item[7] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 240, 416);
        ...
        case rm_a0h24:
            ...
            if (!(oControl.mod_previous_room == 398 && global.item[8] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 192, 176);
        ...
        case rm_a4h09:
            ...
            {
                var mtid = tile_layer_find(-111, 576, 112);
        ...
        case rm_a1a06:
            ...
            if (!(oControl.mod_previous_room == 400 && global.item[8] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 272, 592);
        ...
        case rm_a3a20:
            ...
            if (!(oControl.mod_previous_room == 405 && global.item[7] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 368, 128);
            ...
            if (!(oControl.mod_previous_room == 395 && global.item[8] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 80, 416);
        ...
        case rm_a2h02:
            ...
            if (!(oControl.mod_previous_room == 402))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 2048, 64);
        ...
        case rm_a0h03:
            ...
            var blk = instance_create(448, 432, oBlockSpeed);
            blk.regentime = 1;
        ...
        case rm_a2c08:
            ...
            if (!(oControl.mod_previous_room == 401 && global.item[8] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 848, 576);
        ...
        case rm_a4h03:
            ...
            {
                var mtid = tile_layer_find(-111, 48, 336);
            ...
            if (!(oControl.mod_previous_room == 406 && global.item[8] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 1552, 560);
        ...
        case rm_a3b02:
            ...
            if (!(oControl.mod_previous_room == 404 && global.item[8] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 224, 1040);
        ...
        case rm_a3b05:
            ...
            {
                var mtid = tile_layer_find(-111, 112, 832);
        ...
        case rm_a6a10:
            ...
            if (!(oControl.mod_previous_room == 407 && global.item[8] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 608, 576);
        ...
        case rm_a6b03:
            ...
            if (!(oControl.mod_previous_room == 408 && global.item[8] == 0))
            {
            ...
            {
                var mtid = tile_layer_find(-111, 240, 352);
        ...
        case rm_a2c05:
            ...
            {
                var mtid = tile_layer_find(-111, 48, 608);
        ...
        case rm_a6b05:
            ...
            {
                var mtid = tile_layer_find(-111, 256, 96);
        ...
        case rm_a6b10:
            ...
            if (!(oControl.mod_previous_room == 409 && global.ptanks == 0))
            {
                var blk = instance_create(48, 192, oBlockPBomb);
                blk.regentime = -1;
            }
            else
            {
                var mtid = tile_layer_find(-111, 48, 192);
        ...
        case rm_a1h04:
            ...
            if (!(oControl.mod_previous_room == 399 || global.event[75] == 1))
            {
        ...
        case rm_a0h32:
            ...
            tile_layer_delete(-130);
            var blk = instance_create(96, 832, oBlockScrew);
            blk.regentime = -1;
            break;
