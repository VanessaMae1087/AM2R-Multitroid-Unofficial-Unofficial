...
{
    writelog("WARN: Surface s_map (ID " + string(s_map) + ") does not exist! Freeing and recreating... [oSS_Control Step]")
    surface_free(s_map);
    s_map = surface_create(2048, 1024);
    writelog("Info: New surface s_map has ID " + string(s_map) + " [oSS_Control Step]")
